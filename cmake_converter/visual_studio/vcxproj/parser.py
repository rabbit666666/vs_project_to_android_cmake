...
class VCXParser(Parser):
    ...
    def get_node_handlers_dict(self, context):
        ...
        node_handlers.update({
            ...
            'UseOfStl': self.__parse_use_of_stl,
            'AndroidAPILevel': self.__parse_android_api_level,
            ...
            'LibraryDependencies': context.dependencies.set_target_additional_dependencies,
            'AdditionalLibraryDirectories': context.dependencies.set_target_additional_library_directories,
    ...
    @staticmethod
    def __parse_use_of_stl(context, node):
        context.settings[context.current_setting]['use_of_stl'] = node.text

    @staticmethod
    def __parse_android_api_level(context, node):
        context.settings[context.current_setting]['android_api_level'] = node.text
